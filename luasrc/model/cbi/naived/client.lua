...
m = Map("naived", translate("Naived Settings"), translate("<h3>Support NAIVEPROXY</h3>"))
m:section(SimpleSection).template = "naived/status"
...
o:value("9.9.9.9:53", translate("Quad9-Recommended (9.9.9.9)"))
...
if is_finded("dnsproxy") then
	...
	o.description = translate(
    	...
    	" <a href='http://" .. lan_ip .. "/cgi-bin/luci/admin/services/naived/control' target='_blank'>" ..
